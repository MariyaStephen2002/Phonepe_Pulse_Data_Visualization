...
if selected == "Home":
    ...
    with col2:
        ...
        st.write(" ")
        st.write(" ")
        st.image("C:\\Users\\stephen\\Pictures\\BlueStacks\\stat.png")
#MENU 2 - TOP CHARTS
...
# Overall State Data - TRANSACTIONS AMOUNT - INDIA MAP 
        with col1:
            ...
            df2 = pd.read_csv(r'E:\\visual studio\\state_names.csv')
            df1.State = df2
...
if selected == "About":
    ...
    with col2:
        ...
        st.write(" ")
        st.write(" ")
        st.image("C:\\Users\\stephen\\Pictures\\BlueStacks\\Pulseimg.jpg")
